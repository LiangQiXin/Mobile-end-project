<template>
  <div>
      ...
      <router-link :to="'/'">
       <img :src="endImg" alt="">
       <img class="Me_tishi" :src="hongDian" alt="">
       </router-link>
      </div>
    </div>
    <!-- 下面的背景及账号 -->
    <div class="Me_bg">
      ...
      <!-- 人物头像左边的图片 -->
      <div class="my_LuFei" ref="toTop2" :style="style01 == 0 ?'transition:all .5s linear;display:none;':''">
        <router-link :to="'/'">
      ...
      <div>
        <router-link :to="'/'">
        <img src="@/assets/Me_JT.png" alt="" class="my_JTImg">
        </router-link>
      </div>
    </div>
    </div>
...
.Me_bg{
  width:100%;
  height:180px;
 background: url("../../../assets/Me_bg.jpg") no-repeat 100% ;
}
/*显示账号人物*/
.Me_bg .bg_img{
    width:50px;
